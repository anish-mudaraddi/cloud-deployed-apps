...
helm upgrade --install argocd-apps ../charts/$ENVIRONMENT/deps/argocd-apps -n argocd -f ../charts/$ENVIRONMENT/deps/argocd-apps/values.yaml -f ../envs/$ENVIRONMENT/app-values.yaml -f ../envs/$ENVIRONMENT/$CLUSTER_NAME/app-values.yaml --wait
